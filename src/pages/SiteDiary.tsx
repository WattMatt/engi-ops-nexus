...
import { ArrowLeft, Plus, Calendar, Cloud } from "lucide-react";
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-foreground">Site Diary</h1>
                <p className="text-sm text-muted-foreground">Track daily site progress and activities</p>
              </div>
            </div>
            ...
            {entries.map((entry) => (
              <Card key={entry.id} className="hover:shadow-md transition-shadow">
                ...
                <CardContent className="space-y-4">
                  {entry.site_progress && (
                    <div>
                      <h4 className="font-semibold text-sm mb-2 text-foreground">Site Progress</h4>
                  ...
                  {entry.queries && (
                    <div>
                      <h4 className="font-semibold text-sm mb-2 text-foreground">Queries & Issues</h4>
                      <p className="text-sm text-muted-foreground whitespace-pre-wrap">
                        {entry.queries}
                      </p>
                    </div>
