...
// Simplified table for copper conductors, PVC insulated cables
...
// Standard cable sizes with typical ratings
export const CABLE_SIZING_TABLE: CableData[] = [
...
export function calculateCableSize(
  ...
  const { loadAmps, voltage, totalLength, deratingFactor = 1.0 } = params;
  ...
  const selectedCable = CABLE_SIZING_TABLE.find(
