...
- Bulk update capability`,
  },
  {
    ...
    deliverables: [
      ...
      { id: '2-3', title: 'In-app document preview', completed: false },
      { id: '2-4', title: 'AI-powered data extraction (using google/gemini-2.5-flash)', completed: false },
      { id: '2-5', title: 'Auto-parse specs from uploaded PDFs', completed: false },
      { id: '2-6', title: 'Confidence scoring for extracted data', completed: false },
      { id: '2-7', title: 'One-click add parsed fitting to library', completed: false },
      { id: '2-8', title: 'Duplicate detection and warnings', completed: false },
    ],
