...
- Summary of extraction results`,
  },
  {
    ...
    status: 'complete',
    deliverables: [
      { id: '3-1', title: 'Side-by-side comparison tool (2-6 fittings)', completed: true },
      { id: '3-2', title: 'Visual comparison matrix with highlighted differences', completed: true },
      { id: '3-3', title: 'Save comparisons for future reference', completed: true },
      { id: '3-4', title: 'Total cost calculation (Supply + Install)', completed: true },
      { id: '3-5', title: 'Project cost projection based on quantities', completed: true },
      { id: '3-6', title: 'Cost per lumen efficiency metric', completed: true },
      { id: '3-7', title: 'Energy consumption estimates (kWh)', completed: true },
      { id: '3-8', title: 'Monthly/annual running cost calculations', completed: true },
    ],
...
- Include VAT toggle`,
  },
  {
    ...
    status: 'complete',
    deliverables: [
      { id: '4-1', title: 'Comprehensive lighting report generator', completed: true },
      { id: '4-2', title: 'Per-tenant lighting schedules', completed: true },
      { id: '4-3', title: 'Compiled specification sheets section', completed: true },
      { id: '4-4', title: 'Approval tracking per area/tenant', completed: true },
      { id: '4-5', title: 'Professional PDF export with cover page and TOC', completed: true },
      { id: '4-6', title: 'Embedded images and charts in reports', completed: true },
      { id: '4-7', title: 'Reusable report templates', completed: true },
      { id: '4-8', title: 'Client portal integration with approval workflow', completed: true },
    ],
...
\`\`\``,
  },
  {
    ...
    status: 'complete',
    deliverables: [
      { id: '5-1', title: 'Floor plan integration - drop fittings on plan', completed: true },
      { id: '5-2', title: 'Auto-calculate quantities from placed fittings', completed: true },
      { id: '5-3', title: 'Zone assignment for fittings', completed: true },
      { id: '5-4', title: '3D light cone preview', completed: true },
      { id: '5-5', title: 'Lux simulation and visual distribution', completed: true },
      { id: '5-6', title: 'IES file support for photometric data', completed: true },
      { id: '5-7', title: 'Lux level calculations and compliance checks', completed: true },
      { id: '5-8', title: 'Supplier quote requests integration', completed: true },
      { id: '5-9', title: 'Price sync with supplier databases', completed: true },
    ],
