...
const PLACEHOLDER_GROUPS: PlaceholderGroup[] = [
  ...
  },
  {
    ...
    placeholders: [
      ...
      { name: "{{total_previous_report}}", description: "Total previous report amount" },
      { name: "{{total_anticipated_final}}", description: "Total anticipated final amount" },
      { name: "{{total_current_variance}}", description: "Total current variance (from previous report)" },
      { name: "{{total_original_variance}}", description: "Total original variance (from original budget)" },
...
const LOOP_GROUPS = [
  {
    ...
    fields: [
      ...
      { name: "{previous_report}", description: "Previous cost report amount" },
      { name: "{anticipated_final}", description: "Anticipated final amount" },
      { name: "{percentage_of_total}", description: "Percentage of total original budget" },
      { name: "{current_variance}", description: "Variance from previous report" },
      { name: "{original_variance}", description: "Variance from original budget" },
    ],
  },
  {
