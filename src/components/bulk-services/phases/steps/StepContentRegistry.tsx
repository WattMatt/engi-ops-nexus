...
import { PrepareApplicationStep, DocumentMaxDemandStep, LoadProfileDocStep, VoltageRequestStep, SubmitApplicationStep, TariffSelectionStep } from './phase3';
import { UtilityReviewStep, NetworkAssessmentStep, TechnicalDrawingsStep, ConnectionAgreementStep } from './phase4';
import { InternalInfrastructureStep, SpecificationComplianceStep, GridExtensionStep, TestingCommissioningStep } from './phase5';
import { PowerFactorStep, DemandManagementStep, EquipmentMaintenanceStep, ReportingProceduresStep } from './phase6';
...
const STEP_CONTENT_MAP: Record<string, React.ComponentType<StepContentProps>> = {
  ...
  'Document maximum demand': DocumentMaxDemandStep,
  ...
  'Build internal infrastructure': InternalInfrastructureStep,
