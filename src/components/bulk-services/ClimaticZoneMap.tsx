...
export const ClimaticZoneMap = forwardRef<{ captureMap: () => Promise<Blob> }, ClimaticZoneMapProps>(
  ...
  useEffect(() => {
    if (!map.current || !selectedZone || !selectedCoordinates) return;
    ...
    if (map.current.isStyleLoaded()) {
      ...
      map.current.once('load', addSelectedMarker);
    }
  }, [selectedZone, selectedCoordinates, selectedCity, mapboxToken]);
