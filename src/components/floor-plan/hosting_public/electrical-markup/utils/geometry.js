 ...
 * @param {import('./types.js').Point} point The point to check.
 * @param {import('./types.js').Point[]} polygon An array of points defining the polygon's vertices.
 ...
 * @param {import('./types.js').PVArrayItem} array The PV array item.
 * @param {import('./types.js').PVPanelConfig} pvPanelConfig The configuration of the PV panels.
 * @param {import('./types.js').RoofMask[]} roofMasks A list of all roof masks to find the correct pitch.
 * @param {import('./types.js').ScaleInfo} scaleInfo The current drawing scale information.
 * @returns {import('./types.js').Point[]} An array of 4 points representing the corners of the array.
 */
 ...
 * @returns {{ snappedPosition: import('./types.js').Point; snapLines: { start: import('./types.js').Point; end: import('./types.js').Point }[] } | null} An object with the snapped position and guide lines, or null.
 */
