...
interface EquipmentDocumentsViewProps {
  projectId: string;
...
export const EquipmentDocumentsView = ({
  projectId,
  equipmentType,
  equipmentLabel,
  icon,
  ...
  const { data: documents = [], isLoading } = useQuery({
    queryKey: ["equipment-documents", projectId, equipmentType],
    queryFn: async () => {
      const { data, error } = await supabase
        ...
        .eq("document_type", equipmentType)
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                {equipmentLabel} documents uploaded
              </p>
            </CardContent>
          </Card>
          ...
          <CardContent className="space-y-4">
            ...
            {isLoading ? (
              ...
              <div className="text-center py-12 text-muted-foreground">
                ...
                <p className="text-lg font-medium">No {equipmentLabel} Documents Yet</p>
